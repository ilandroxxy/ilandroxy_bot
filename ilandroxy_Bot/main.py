...
def mess(message):
    ...
    # todo: Добавить в кнопку [Мои проекты] и в соответсвующую команду ссылки на "Работы с учениками: перечислить боты и описание проектов"
        ...
        send_message2 = "Совместные проекты с моими учениками:\n\n" \
                        '*1. Чат бота Телеграм* @kto_hochet_stat_millioneromBOT\nАвторы: @ilandroxxy и Шариф Георгий 6 класс\nЦель проекта: сделать викторину по аналогии игры "Кто хочет стать миллионером"\n\n' \
                        "*2. Чат бота Телеграм* @NumberOfSystem_Bot\n\n"
