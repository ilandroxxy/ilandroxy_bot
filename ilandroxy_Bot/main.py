...
def step(call):
    ...
    if call.data == 'price':
        ...
        message_text = f"*Первое занятие БЕСПЛАТНО*,\n" \
                       ...
                       f"[Записаться на урок можно тут](https://planerka.app/meet/ilandroxy/tutor). "
        bot.send_message(call.message.chat.id, message_text, parse_mode="Markdown",
                         disable_web_page_preview=True, reply_markup=markup)

    elif call.data == "iam":
        send_message1 = f'Я имею высшее образование в области айти, учился и успешно закончил ' \
                        f'`"Сибирский государственный университет телекоммуникаций и информатики"`, ' \
                        f'факультет: `"Информатики и Вычислительной техники"` . Мой стек технологий ' \
                        f'включает синтаксис Python, библиотеки `Telebot`/`Aiogram`, `Git`, `MySQL` и другие. ' \
                        f'Моя задача - помочь моим ученикам успешно сдать экзамен ЕГЭ по информатике ' \
                        f'или начать свой путь в программировании. Я готов предложить индивидуальный ' \
                        f'подход к каждому ученику и настроить программу обучения под его потребности ' \
                        f'и уровень подготовки! 🧑‍🎓\n\n' \
                        f'В настоящее время я обучаюсь по государственной программе "Цифровые профессии" ' \
                        f'в Яндекс Практикуме по направлению "Python developer". Мой стаж репетиторской ' \
                        f'деятельности составляет более 3 лет, в моем профиле можно ознакомиться с ' \
                        f'отзывами учеников и родителей. Если вы хотите получить качественное обучение ' \
                        f'информатике и программированию, обращайтесь к мне 🙏'
        ...
        send_message2 = f" \n\n🎯 Цель открыть свою школу программирования " \
                        ...
                        f"Общий стаж репетиторской деятельности *больше 4 лет*! " \
...
def link_yandex_project(message):
    markup2 = types.InlineKeyboardMarkup(row_width=1)
    markup2.add(types.InlineKeyboardButton("Таск Треккер 🎯", url='https://twisty-crater-e76.notion.site/1921fe8a34a847ae81c29f5a39046d00?v=cfd92fc0f6fe4f55b14f340963842482'))

    send_message = f"Пользуемся благами телеграмм: \n\n"
    bot.send_message(message.chat.id, send_message, reply_markup=markup2, parse_mode='Markdown')
...
def mess(message):
    ...
    # region Кнопка: [Контакты] +
        ...
        send_message1 = "*Мои контакты:*\n\n" \
                        "Сайт портфолио [ilandroxxy.github.io](https://ilandroxxy.github.io/)\n\n" \
                        "[Telegram](t.me/ilandroxy) or @ilandroxy\n\n" \
                        "[WhatsApp](wa.me/message/JSXJ2NLWTVNFC1)    " \
                        "[VKontakte](https://vk.com/ilandroxxy)\n\n" \
                        "[Discord сервер](https://discord.gg/Bva5m9yWyE) and me: `ilandroxxy#6249`\n\n" \
                        "[Zoom](https://us04web.zoom.us/j/2402871810?pwd=OVdGQkE2ODIvWm1WNk5EdStQR1o4UT09)    " \
                        "[Google Meet](https://meet.google.com/bcm-xhcm-stn)\n\n" \
                        "Профиль на [Авито](www.avito.ru/user/590293c00d3ab79d83e929a6731df164/profile?src=sharing)" \
                        " и [Профи](https://profi.ru/profile/AndrianovIA10)\n\n" \
    ...
    # region Кнопка: [Мои проекты] +
        ...
        send_message1 = "*Просто перечисляю, чем я занимаюсь сегодня:*\n\n" \
                        ...
                        "*2. Канал:* [itpy | ИнформатикаЕГЭ](t.me/itpy_kege)\n" \
                        ...
                        "*4. Чат бот:* 🤖[MotherBot](t.me/JustDoItMotherBot)\n" \
                        "*Github проекта:* [link](https://github.com/ilandroxxy/MotherBot2.0)  \nЭто мой первый Telegram бот, " \
        ...
        send_message2 = "*Совместные проекты с моими учениками:*\n\n" \
                        '*1. Чат бот:* 🤖 [@kto_hochet_stat_millioneromBOT]\n' \
                        '*Github проекта:* [link](https://github.com/ilandroxxy/WhoWantsToBecomeAMillioner)\n' \
                        ...
                        '*2. Чат бот:* 🤖 [@NumberOfSystem_Bot]\n' \
                        '*Github проекта:* [link](https://github.com/ilandroxxy/NumberSystems)\n*Авторы:* ' \
                        ...
                        '*3. Чат бот:* 🤖 [@YaninaFractions_Bot]\n' \
                        '*Github проекта:* [link](https://github.com/ilandroxxy/YaninaFractions_Bot)\n*Авторы:* ' \
                        ...
                        '*4. Чат бота:* 🤖 [@CalculationInTheMind_Bot]\n' \
                        '*Github проекта:* [link](https://github.com/Lizzerd7/CalculationInTheMind)\n*Авторы:* ' \
    ...
    # region Кнопка: [Репетитор] +
        ...
        if message.chat.id == 1891281816:
            ...
            send_message1 = f"Сейчас ведется набор на новый учебный год 2023/24, который начинается с 1 июля. " \
                            f"Я предлагаю полностью дистанционное обучение с использованием сервисов `PyCharm`, " \
                            f"`Discord`, `Notion`, `Tеlеgrамм`, `Stepik` и многих других. Более подробную информацию " \
                            f"о моих услугах и расписании можно найти в моем боte [ilandroxy_Bot] 🤖"
            ...
            send_message3 = f"Я провожу как индивидуальные, так и групповые занятия. Групповые занятия " \
                            f"проводятся в небольших группах до 4-х человек, что помогает учащимся общаться, " \
                            f"делиться опытом и учиться друг у друга. В групповых занятиях я предоставляю " \
                            f"задания и упражнения, которые помогают развивают навыки командной работы. 🧑‍💻"
            ...
            send_message4 = f"Моя методика обучения заключается в том, чтобы помочь ученикам укрепить " \
                            f"понимание основ информатики и программирования и научить их решать задачи, " \
                            f"используя полученные знания. Мои занятия проходят в дружественной и неформальной " \
                            f"обстановке, и я всегда стараюсь учитывать потребности каждого ученика и " \
                            f"адаптировать программу обучения под уровень подготовки и уникальные потребности.\n\n" \
                            f"Стоимость моих занятий зависит от выбранного типа и пакета обучения. " \
                            f"Я предлагаю индивидуальные занятия по цене *от 1500 рублей в час* и групповые " \
                            f"занятия по цене *от 1000 рублей в час* на человека. Также у меня есть различные " \
                            f"абонементы, которые позволяют сэкономить при оплате большого количества занятий " \
                            f"я предоставить *скидку до 15%*. Я работаю официально и через НПД (*Самозанятый*)."
