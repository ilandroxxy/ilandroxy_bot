...
# 5 № 7584 Досрочная волна 2023 (Уровень: Средний)
...
# todo: Никита = [1, 2, 3, 4, 5, 6, 7, 8, 9.1, 11, 12, 13, 14+, 15+, 16, 17, 18, 19-21, 23, 24+, 25.2]
# на прошлом уроке: Повторяли теорию игр, 10 и 22 номера.
# на следующем уроке:
