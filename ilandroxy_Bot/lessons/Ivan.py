...
# todo: Иван = [2, 8, 10, 12, 13, 14+, 15+, 16, 23]
# на прошлом уроке: Прорешали 16 номер с рекурсией, потупили на 6 номере с черепахой и прорешали 23 номер на повторение.
# на следующем уроке:  # Черепаха с КЕГЭ, закрепляем 23 номер.