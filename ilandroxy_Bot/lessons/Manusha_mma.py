...
# Введите первую строку: с мая весной
# Введите вторую строку: сам я не свой
# No
# [' ', ' ', 'а', 'в', 'е', 'й', 'м', 'н', 'о', 'с', 'с', 'я']
# [' ', ' ', ' ', 'а', 'в', 'е', 'й', 'м', 'н', 'о', 'с', 'с', 'я']


# Пователем ключ в словаре и выдаёт значение этого ключа на экран.
...
def find_key(dictionary, key, max_depth):
    stack = [(dictionary, 0)]

    while stack:
        current_dict, depth = stack.pop()
        print(current_dict, depth)
...
ask = input("Хотите ввести максимальную глубину? Y/N: ").lower()
